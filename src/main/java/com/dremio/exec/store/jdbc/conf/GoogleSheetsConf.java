...
@SourceType(value = "GoogleSheetsARP", label = "GoogleSheets",uiConfig = "googlesheets-layout.json")
public class GoogleSheetsConf extends AbstractArpConf<GoogleSheetsConf> {
  private static final String ARP_FILENAME = "arp/implementation/googlesheets-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.googlesheets.GoogleSheetsDriver";
